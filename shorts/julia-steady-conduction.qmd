...
Temperature profile across plate with convection boundary condition is presented in @fig-results-1.
...
Temperature profile across plate with radiation enabled is presented in @fig-results-2.
