...
If this subject is new to you, to be able to successfully follow the contents you might learn a bit about the environment we will use, [VS Code @sec-vscode] and the minimum about command prompt on [Chapter @sec-working-on-windows].
